...
data_dir = os.path.join( '/content/Peyman-Fold1/data/Fold1/')
...
output_dir = './content/Peyman-Fold1/output/'
...
def evaluate(model, predict_dataloader, batch_size, epoch_th, dataset_name):
    ...
    with open("/content/Peyman-Fold1/data/Fold1/train.txt", "w") as writer:
            ...
            nextfile=open("/content/Peyman-Fold1/data/Fold1/valid.txt", "w")
